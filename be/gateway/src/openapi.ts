export const openapiSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "OpenAPI documentation for API Gateway. Most endpoints proxy to underlying services.",
  },
  servers: [{ url: "/" }],
  tags: [
    { name: "Health" },
    ...
    schemas: {
      SendMessageRequest: {
        ...
        properties: {
          conversationId: {
            type: "string",
            description: "Provide when replying in an existing conversation",
          },
          shopId: {
            type: "string",
            description: "Provide when buyer starts a new conversation",
          },
  ...
  paths: {
    ...
    "/api/inventory": {
      post: {
        tags: ["Inventory"],
        summary: "Create inventory entry (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  productId: {
                    type: "string",
                    example: "6639f3e0c1d2a3b4c5d6e7f8",
                  },
    ...
    "/api/inventory/search": {
      get: {
        tags: ["Inventory"],
        summary: "Search inventory by name (internal)",
        parameters: [
          {
            name: "name",
            in: "query",
    ...
    "/api/inventory/seller/{sellerId}": {
      get: {
        tags: ["Inventory"],
        summary: "Get inventory by seller id (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "sellerId",
    ...
    "/api/inventory/{inventoryId}": {
      get: {
        tags: ["Inventory"],
        summary: "Get inventory by id (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "inventoryId",
      ...
      put: {
        tags: ["Inventory"],
        summary: "Update inventory quantity (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "inventoryId",
      ...
      delete: {
        tags: ["Inventory"],
        summary: "Delete inventory (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "inventoryId",
    ...
    "/api/inventory/{inventoryId}/buy": {
      post: {
        tags: ["Inventory"],
        summary: "Buy inventory item (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "inventoryId",
    ...
    "/api/inventory/buy/batch": {
      post: {
        tags: ["Inventory"],
        summary: "Buy inventory items in batch (internal)",
        requestBody: {
          required: true,
          content: {
            "application/json": {
    ...
    "/api/inventory/check": {
      post: {
        tags: ["Inventory"],
        summary: "Check inventory availability (internal)",
        requestBody: {
          required: true,
          content: {
            "application/json": {
    ...
    "/api/inventory/{inventoryId}/restore": {
      post: {
        tags: ["Inventory"],
        summary: "Restore inventory item (internal)",
        parameters: [
          {
            name: "inventoryId",
            in: "path",
    ...
    "/api/inventory/restore/batch": {
      post: {
        tags: ["Inventory"],
        summary: "Restore inventory items in batch (internal)",
        requestBody: {
          required: true,
          content: {
            "application/json": {
    ...
    "/api/redis/recommendations/{userId}": {
      get: {
        tags: ["Redis"],
        summary: "Get recommendations for user (internal)",
        parameters: [
          {
            name: "userId",
            in: "path",
      ...
      post: {
        tags: ["Redis"],
        summary: "Add recommendation for user (internal)",
        parameters: [
          {
            name: "userId",
            in: "path",
    ...
    "/api/redis/recommendations-recent/{userId}": {
      get: {
        tags: ["Redis"],
        summary: "Get recent recommendations for user (internal)",
        parameters: [
          {
            name: "userId",
            in: "path",
    ...
    "/api/sellers/create": {
      post: {
        tags: ["Sellers"],
        summary: "Create seller account (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    "/api/sellers/verify": {
      post: {
        tags: ["Sellers"],
        summary: "Verify seller account (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    "/api/sellers/{userId}": {
      get: {
        tags: ["Sellers"],
        summary: "Get seller profile (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "userId",
      ...
      put: {
        tags: ["Sellers"],
        summary: "Update seller profile (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "userId",
      ...
      delete: {
        tags: ["Sellers"],
        summary: "Delete seller profile (requires Bearer token)",
        security: [{ BearerAuth: [] }],
        parameters: [
          {
            name: "userId",
        ...
        parameters: [
          {
            ...
            description: "Cursor — ISO date of last item for pagination",
          },
          {
            name: "limit",
            in: "query",
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/ConversationView" },
                    },
      ...
      get: {
        ...
        parameters: [
          ...
          },
          {
            ...
            required: false,
            schema: { type: "string" },
            description: "Message ID — load older messages (scroll up)",
          },
          {
            name: "after",
            in: "query",
            required: false,
            schema: { type: "string" },
            description: "Message ID — poll for newer messages",
          },
          {
            name: "limit",
            in: "query",
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      type: "array",
                      items: { $ref: "#/components/schemas/MessageView" },
                    },
                    hasMore: { type: "boolean" },
                    nextCursor: { type: "string", nullable: true },
                  },
